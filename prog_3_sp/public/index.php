...
require_once "../src/poo/juguete.php";
...
$app->get('/juguetes[/]', Juguete::class . ':TraerTodos')->add(MW::class . ':IdImparesJuguetes');
...
$app->group('/toys',  function(RouteCollectorProxy $grupo){
  ...
  $grupo->post('[/]', Juguete::class . ':ModificarUno' );
    ...
    $app->post('/login[/]', function (Request $request, Response $response, array $args) : Response { 
        ...
        $jwt = Autentificadora::crearJWT($usuario,120);
    ...
    $app->group('/tablas',  function(RouteCollectorProxy $grupo){
        ...
        $grupo->get('/usuarios[/]', Usuario::class . ':TraerTodos')->add(MW::class . '::ListadoTablaGet');
        $grupo->post('/usuarios[/]', Usuario::class . ':TraerTodos')->add(MW::class.'::ListadoUsuariosPropietario')->add(MW::class . ':verificarToken');
